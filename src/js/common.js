...
const skrollr = require('./lib/skrollr');
( function( $ ) {
	'use strict';
...
$(function() {
	...
	**/
	...
	/**
		Collapse
	**/
	$('.sannytech-collapse-item').on('click', '.sannytech-collapse-btn', function(){
		if($(this).closest('.sannytech-collapse-item').hasClass('opened')) {
			$(this).closest('.sannytech-collapse-item').removeClass('opened');
			$(this).removeClass('active');
		}
		else {
			$(this).closest('.sannytech-collapse-item').addClass('opened');
			$(this).addClass('active');
		}
	});
